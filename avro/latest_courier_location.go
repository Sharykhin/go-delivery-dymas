...
func (r LatestCourierLocation) Schema() string {
	return "{\"fields\":[{\"name\":\"courier_id\",\"type\":\"string\"},{\"name\":\"latitude\",\"type\":\"double\"},{\"name\":\"longitude\",\"type\":\"double\"},{\"logicalType\":\"timestamp-millis\",\"name\":\"created_at\",\"type\":\"long\"}],\"name\":\"LatestCourierLocation\",\"type\":\"record\"}"
}
